const AnimateIn = () => {
  ...
  var TextPlugin_gsap,
    TextPlugin_tempDiv,
    TextPlugin_getGSAP = function _getGSAP() {
      return (
        TextPlugin_gsap ||
        (typeof window !== "undefined" &&
          (TextPlugin_gsap = window.gsap) &&
          TextPlugin_gsap.registerPlugin &&
          TextPlugin_gsap)
      );
    };
  var TextPlugin = {
    ...
    init: function init(target, value, tween) {
      ...
      TextPlugin_tempDiv ||
        (TextPlugin_tempDiv = document.createElement("div"));
  ...
  da.init();
  window["FLS"] = true;
  gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger, TextPlugin);

  if (document.querySelector(".hero")) {
    const heroBlock = document.querySelector(".hero");
    const heroBlockBefore = heroBlock?.querySelector(".hero__before");
    const heroBlockAfter = heroBlock?.querySelector(".hero__after");
    document?.querySelectorAll(".title");
    const textElement = document?.querySelector(".hero__title") || {};
    const imageElement = document.querySelector(".hero__img");
    console.log(imageElement);
    const blockLeftElement = document.querySelector(".hero__list");
    const blockRightElement = document.querySelector(".hero__description");
    const heroItems = blockLeftElement?.querySelectorAll(".hero-item");
    const heroTextRight = heroBlock?.querySelectorAll(".hero__text--right");
    const heroTextLeft = heroBlock?.querySelectorAll(".hero__text--left");
    ...
    tl.from(".capable__items .capable-item", {
      x: -200,
      duration: 1,
      opacity: 0,
      stagger: 0.05,
    ...
    heroTl.from(".masks__items .mask-item", {
      y: 200,
      duration: 1,
      stagger: 0.05,
      yoyo: true,
    ...
    tl.from(".best-block__items  .atom-list li", {
      x: 200,
      duration: 1,
      stagger: 0.05,
      yoyo: true,
    ...
    tl.from(".safety__items .safety-item", {
      scale: 0.5,
      duration: 0.5,
      stagger: 0.05,
      ease: "power2.out",
    ...
    const items = document?.querySelectorAll(".counter-value");
